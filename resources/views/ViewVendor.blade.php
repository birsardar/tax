            ...
            <tr>
                ...
                <td>
                    <h2 class="table-avatar">
                        ...
                        <a href="">{{ $vendorRecord->VendorName }} <span>{{ $vendorRecord->Email }}</span></a>
                    </h2>
                </td>
                ...
                <td class="d-flex align-items-center">
                    ...
                    <div class="dropdown dropdown-action">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <ul>
                                <li>
                                    <a class="dropdown-item" href="{{ route('delete-vendor', ['id' => $vendorRecord->VendorId]) }}" >
     ...
     @csrf
      ...
      <div class="col-lg-12 col-sm-12">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="email" placeholder="Enter Email Address" required name="email">
        </div>
      </div>
      <div class="col-lg-12 col-sm-12">
        <div class="form-group">
      ...
      <div class="col-lg-12 col-sm-12">
        <div class="form-group ">
          ...
          <input type="text" class="form-control" id="pan" placeholder="Enter PAN No." required name="pan">
        </div>
      </div>
      <div class="col-lg-12 col-sm-12">
        <div class="form-group">
          <label for="gst">GST No.<span class="optional">(Optional)</span></label>
          <input type="text" class="form-control" id="gst" placeholder="Enter GST No." name="gst">
        </div>
      </div>
      <div class="col-lg-12 col-sm-12 mb-0">
        <div class="form-group">
          <label for="bankname">Bank Name</label>
          <input type="text" class="form-control" id="bankname" placeholder="Enter Bank Name" required name="BankName">
        </div>
        <div class="form-group">
          <label for="ifsc">IFSC</label>
          <input type="text" class="form-control" id="ifsc" placeholder="Enter Bank IFSC here" required name="IFSC">
        </div>
        <div class="form-group">
          <label for="accountnumber">Account Number</label>
          <input type="text" class="form-control" id="accountnumber" placeholder="Enter Account Number" required name="BankAccount">
        </div>
    
        
        <div class="modal-footer">
    <button class="btn btn-primary paid-cancel-btn me-2" onclick="cancelForm()">Cancel</button>
...
@foreach($vendor as $vendorRecord)
<form id="editVendorForm" method="POST" action="{{ route('update-vendor',['id' => $vendorRecord->VendorId]) }}">
    @csrf
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="form-group">
                    <label for="phone">Phone Number</label>
                    <input type="text" class="form-control" id="phone" name="phone" placeholder="Enter Reference Number">
                </div>
            </div>
            <div class="col-lg-12 col-md-12">
                <div class="form-group mb-0">
                    <label for="balance">PAN no.</label>
                    <input type="text" class="form-control" id="pan" name="pan" placeholder="Enter Reference Number">
                </div>
            </div>
            <div class="col-lg-12 col-sm-12 mb-0">
        <div class="form-group">
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-primary paid-cancel-btn me-2" data-bs-dismiss="modal">Cancel</button>
...
<div class="modal custom-modal fade" id="delete_modal" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            <form id="deleteVendorForm" method="POST" action="{{ route('delete-vendor',['id' => $vendorRecord->VendorId]) }}">
                @csrf
                <div class="modal-body">
...
<script>
    ...
    // Validate the fields
    if (!validateName() || !validateEmail() || !validatePhoneNumber() || !validatePAN() || !validateBankName() || !validateIFSC() || !validateAccountNumber()) {
      return;
    }
