...
<li>
<a class="btn btn-primary" href="{{ route('add-invoice') }}"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>New Invoice</a>
</li>
</ul>
</div>
</div>
...
<td>
    <div class="dropdown dropdown-action">
        ...
        <div class="dropdown-menu dropdown-menu-end">
            <a class="dropdown-item delete-action"  href="{{ route('delete-invoice', ['id' => $invoice->InvoiceId]) }}">
