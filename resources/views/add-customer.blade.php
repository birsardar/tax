    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form id="customerForm" action="{{ route('add.customer.submit') }}" method="post"
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    placeholder="Enter PAN Number" required name="PanNumber">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <div class="form-group notes-form-group">
                                                <label>IFSC</label>
                                                <input type="text" class="form-control" placeholder="Bank IFSC here"
                                                    required name="IFSC">
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <div class="form-group">
                                                <label>GST No</label>
                                                <input type="text" class="form-control"
                                                    placeholder="Enter GST Number" required name="GstNumber">
                                            </div>
                                        </div>
                                    </div>
                                </div>
