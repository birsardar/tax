                        ...
                        <div class="invoiceapp-detail-wrap">
                            ...
                            <div class="invoice-body">
                                <div data-simplebar class="nicescroll-bar">
                                    <div class="container">
                                        <form method="post"
                                            action="{{ route('create-purchase-bill-submit', ['id' => $VendorDetail[0]->VendorId]) }}">
                                                        ...
                                                        <div class="collapse show" id="address_collpase">
                                                            <div class="address-wrap">
                                                                <h6><input type="text" name="PartyName"
                                                                        value={{ $user[0]->CustomerName }}>
                                                                </h6>
                                                                <p>{{ $user_profile[0]->office_address }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <input class="form-control" type="text"
                                                                            value="{{ $VendorDetail[0]->VendorName }}ds"
