                    ...
                    <div class="content-page-header">
                        ...
                        <div class="list-btn">
                            <ul class="filter-list">
                                ...
                                <li>
                                    <a class="btn btn-primary" href="{{ route('add-customer') }}"><i
                                            ...
                                            @foreach ($customer as $customerRecord)
                                                <tr>
                                                    ...
                                                    <td class="d-flex align-items-center">
                                                        <a href="{{ route('customer-invoice', ['id' => $customerRecord->id]) }}"
                                                                ...
                                                                <ul>
                                                                    <li>
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('delete-customer', ['id' => $customerRecord->CustomerId]) }}"><i
                                                                                class="far fa-trash-alt me-2"></i>Remove</a>
                                                                    </li>
                                                ...
                                                <div class="col-md-12">
                                                    <div id="checkBoxes1">
                                                        <div class="form-custom">
                                                            <input type="text" class="form-control"
                                                                id="member_search1" placeholder="Search here">
                                            ...
                                            <div id="checkBoxes3">
                                                <div class="selectBox-cont">
                                                    ...
                                                    <div class="view-content">
                                                        ...
                                                        <div class="view-all">
                                                            <a href="javascript:void(0);"
                                                                class="viewall-button-Two"><span class="me-2">View
                                                                    All</span><span><i
                                                                        class="fa fa-circle-chevron-down"></i></span></a>
                                                        </div>
                                                    </div>
