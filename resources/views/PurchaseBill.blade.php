                            ...
                            <ul class="filter-list">
                                ...
                                <li>
                                    <a class="btn btn-primary"
                                        href="{{ route('create-purchase-bill', ['id' => $user]) }}"><i
                                            class="fa fa-plus-circle me-2" aria-hidden="true"></i>New Expense</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                                        ...
                                                        <div class="dropdown dropdown-action ">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end "
                                                                ...
                                                                <a class="dropdown-item delete-action"
                                                                    href="{{ route('delete-purchase', ['id' => $purchase->PurchaseId]) }}">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <button type="button"
                                                                    ...
                                                                    id="modal-delete-btn">Delete</button>
                                                            </div>
                                                            <div class="col-6">
