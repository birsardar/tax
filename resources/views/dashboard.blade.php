...
<div class="col-auto">
<a href="{{ route('invoice')}}" class="btn-right btn btn-sm btn-outline-primary">
View All
</a>
</div>
</div>
...
<a href="profile.html"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ url('global_assets/images/images.jpg') }}" alt="User Image">{{$invoice->PartyName}}</a>
</h2>
</td>
<td>$118</td>
