            ...
            <div class="row justify-content-lg-center">
                <div class="col-lg-10">
                    @if ($user_profile === null)
                        <h1>Please complete profile</h1>
                        <a href="{{ route('settings') }}" class="btn btn-primary">Complete Profile</a>
                    @else
                        ...
                        <div class="text-center mb-5">
                            ...
                            <h2>{{ $user_profile->tradename }}<i class="fas fa-certificate text-primary small"
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <i class="far fa-calendar-alt"></i> <span>Joined
                                        {{ $user_profile->created_at->format('d M Y') }}</span>
                                </li>
                            </ul>
                        </div>
                        <div class="row">
                                        ...
                                        <ul class="list-unstyled mb-0">
                                            ...
                                            <li>
                                                <a href="" class="__cf_email__"
                                                    data-cfemail="9dfef5fceff1f8eef5fcfbf3f8efddf8e5fcf0edf1f8b3fef2f0">{{ $user_profile->email }}</a>
                                            </li>
                                            <li>
                                                {{ $user_profile->number }}
                                            </li>
                                    ...
                                    <div class="card-body card-body-height">
                                        <ul class="activity-feed">
                                            <li class="feed-item">
                                                ...
                                                <span class="feed-text"><a href="">Brian Johnson</a> has paid the
                                                    invoice <a href="invoice-details.html">"#DF65485"</a></span>
                                            </li>
                                            <li class="feed-item">
                                                <div class="feed-date">Nov 7</div>
                                                <span class="feed-text"><a href="">Marie Canales</a> has accepted
                                            ...
                                            <li class="feed-item">
                                                ...
                                                <span class="feed-text"><a href="profile.html">Robert Martin</a> gave
                                                    a
                                                    review for <a href="product-details.html">"Dell Laptop"</a></span>
                                            </li>
                                            <li class="feed-item">
